...
<section class="xl:w-1/3 w-2/4 absolute xl:top-[160px] top-[250px] mx-auto xl:left-40 z-[2] left-40">
    ...
    <a href="/detail"><button class="w-32 h-8 mt-5 text-sm duration-300 bg-orange-500 rounded-full hover:text-white hover:bg-orange-600 text-slate-100">Read more</button></a>
</section>
