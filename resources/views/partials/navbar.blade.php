        ...
        <div id="sidebar" class="md:flex md:flex-col md:items-center z-[1] md:z-auto md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-100 top-[-400px] transition-all ease-in-out duration-500">
            <ul class="flex ml-8">
                <li class="my-6 md:my-0">
                    <a href="/" class="px-5 py-3 mx-3 duration-500 rounded hover:bg-orange-400">Home</a>
                </li>
                <li class="my-6 md:my-0">
                    <a href="/products" class="px-5 py-3 mx-3 duration-500 rounded hover:bg-orange-400">Product</a>
                </li>
                <li class="my-6 md:my-0">
                    <a href="/about" class="px-5 py-3 mx-3 duration-500 rounded hover:bg-orange-400">About</a>
                </li>
                <li class="my-6 md:my-0">
                    <a href="/contact" class="px-5 py-3 mx-3 duration-500 rounded hover:bg-orange-400">Contact us</a>
                </li>
            </ul>
        </div>
